...
const Navbar = () => (
  <div id="Navbar" className="navbar max-h-16 nav-gradient-anim bg-primary text-primary-content z-2">

    <div className="m-auto space-x-6 rounded-lg whitespace-nowrap">
